...
size = 100  # the circumference of the roundabout - the bigger it is the more cars can enter
#  but also the longer it takes to travel through it
capacity = size // 25  # How many cars can enter the roundabout simultaneously
